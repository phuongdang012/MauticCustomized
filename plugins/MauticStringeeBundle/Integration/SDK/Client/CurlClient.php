...
use MauticPlugin\MauticStringeeBundle\Integration\SDK\Models\StringeeResponse;
...
class CurlClient
{
    ...
    public function request($url, $method, $data = null, $headers = [], $timeout = null)
    {
        ...
        $headers['X-STRINGEE-AUTH'] = $this->generateAuthToken();
        ...
        return new StringeeResponse($response->getStatusCode(), $response->getContent(), $response->getHeaders());
    }
}
